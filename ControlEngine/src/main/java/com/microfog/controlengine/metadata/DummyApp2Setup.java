...
public class DummyApp2Setup extends ApplicationSetup {
    public DummyApp2Setup(Utils utils) {
        super(utils);
    }
    ...
    public Application generateApplicationObject() throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException {
         ...
         */
        Microservice a2m1 = new Microservice("APP2_m1", new HashMap<>(){
            {
        ...
        Microservice a2m2 = new Microservice("APP2_m2", new HashMap<>(){
            {
        ...
        Microservice a2m3 = new Microservice("APP2_m3", new HashMap<>(){
            {
                put(Microservice.CPU, new BigDecimal(0.8));
                put(Microservice.RAM, utils.getbytesForMib(100));
                put(Microservice.THROUGHPUT, new BigDecimal(100));
        ...
        Microservice a2m4 = new Microservice("APP2_m4", new HashMap<>(){
            {
                put(Microservice.CPU, new BigDecimal(0.6));
                put(Microservice.RAM, utils.getbytesForMib(100));
                put(Microservice.THROUGHPUT, new BigDecimal(100));
        ...
        List<Microservice> microservices = Arrays.asList(new Microservice[]{a2m1, a2m2, a2m3,a2m4});

        Dataflow m1_m2 = new Dataflow(a2m1,a2m2,true);
        Dataflow m2_m1 = new Dataflow(a2m2,a2m1, false);

        Dataflow m2_m3 = new Dataflow(a2m2,a2m3,true);
        Dataflow m3_m2 = new Dataflow(a2m3,a2m2, false);

        Dataflow m2_m4 = new Dataflow(a2m2,a2m4,true);
        Dataflow m4_m2 = new Dataflow(a2m4,a2m2, false);

        List<Dataflow> dataflows = Arrays.asList(new Dataflow[]{m1_m2, m2_m1,m2_m3,m3_m2,m2_m4,m4_m2});

        CompositeService service1 = new CompositeService("APP2_S1",Arrays.asList(new Microservice[]{a2m1, a2m2,a2m3,a2m4}),
                Arrays.asList(Arrays.asList(new Dataflow[]{m1_m2, m2_m3, m3_m2, m2_m1}),
                                            Arrays.asList(new Dataflow[]{m1_m2, m2_m4, m4_m2, m2_m1})  ));
        ...
        Namespace ns = new Namespace(applicationId, "app2", nsLabels);
        ...
        Role role = new Role("app2-role.yaml", "app2","app2");
        ...
        Rolebinding rolebinding = new Rolebinding("app2-rolebinding.yaml", "app2", "app2");
        ...
        Service m1Service = new Service("app2-m1-service.yaml",ns.getName(), Arrays.asList(new String[]{"APP2_m1"}));
        ...
        IstioVirtualService m1VS = new IstioVirtualService("app2-m1-vs.yaml",ns.getName(), IstioVirtualService.Protocols.HTTP, Arrays.asList(new String[]{"APP2_m1"}));
        ...
        IstioDestinationRule m1dr = new IstioDestinationRule("app2-m1-dr.yaml",ns.getName(), Arrays.asList(new String[]{"APP2_m1"}));
        ...
        Gateway m1GW = new Gateway("app2-gateway.yaml",ns.getName(), Arrays.asList(new String[]{"APP2_m1"}));
        ...
        Service m2S = new Service("app2-m2-service.yaml",ns.getName(),Arrays.asList(new String[]{"APP2_m2"}));
        ...
        IstioVirtualService m2vs = new IstioVirtualService("app2-m2-vs.yaml",ns.getName(), IstioVirtualService.Protocols.HTTP, Arrays.asList(new String[]{"APP2_m2"}));
        ...
        IstioDestinationRule m2dr = new IstioDestinationRule("app2-m2-dr.yaml",ns.getName(), Arrays.asList(new String[]{"APP2_m2"}));
        ...
        Service m3S = new Service("app2-m3-service.yaml",ns.getName(),Arrays.asList(new String[]{"APP2_m3"}));
        ...
        IstioVirtualService m3vs = new IstioVirtualService("app2-m3-vs.yaml",ns.getName(), IstioVirtualService.Protocols.HTTP, Arrays.asList(new String[]{"APP2_m3"}));
        ...
        IstioDestinationRule m3dr = new IstioDestinationRule("app2-m3-dr.yaml",ns.getName(), Arrays.asList(new String[]{"APP2_m3"}));
        ...
        Service m4S = new Service("app2-m4-service.yaml",ns.getName(),Arrays.asList(new String[]{"APP2_m4"}));
        ...
        IstioVirtualService m4vs = new IstioVirtualService("app2-m4-vs.yaml",ns.getName(), IstioVirtualService.Protocols.HTTP, Arrays.asList(new String[]{"APP2_m4"}));
        ...
        IstioDestinationRule m4dr = new IstioDestinationRule("app2-m4-dr.yaml",ns.getName(), Arrays.asList(new String[]{"APP2_m4"}));
        ...
        ConfigMap cm1 = new ConfigMap("a2m1-config.yaml",ns.getName(),"APP2_m1");
        ...
        ConfigMap cm2 = new ConfigMap("a2m2-config.yaml",ns.getName(),"APP2_m2");
        ...
        ConfigMap cm3 = new ConfigMap("a2m3-config.yaml",ns.getName(),"APP2_m3");
        ...
        ConfigMap cm4 = new ConfigMap("a2m4-config.yaml",ns.getName(),"APP2_m4");
        ...
        Pod m1 = new Pod("app2-m1.yaml",ns.getName(),"APP2_m1");
        ...
        Pod m2 = new Pod("app2-m2.yaml",ns.getName(),"APP2_m2");
        ...
        Pod m3 = new Pod("app2-m3.yaml",ns.getName(),"APP2_m3");
        ...
        Pod m4 = new Pod("app2-m4.yaml",ns.getName(),"APP2_m4");
